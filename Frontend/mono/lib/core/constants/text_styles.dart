...
class AppTextStyles {
  // Headings
  static TextStyle heading1({Color color = AppColors.black, double fontSize =50}) =>
  ...
  // Body text
  static TextStyle body1({Color color = AppColors.darkGrey, double fontSize =50}) =>
      TextStyle(fontSize: fontSize, fontWeight: FontWeight.normal, color: color);
